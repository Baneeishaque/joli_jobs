  ...
  <div class="row"> 
    ...
    <div class="col-sm-6 margin-bottom-20" style="margin-top: 4%;">
      <div class="col-12 contact-address-box">
        <h3>Reach Us</h3>
        <br>
        <p><i class="fa fa-street-view" aria-hidden="true"></i> 55/558 2nd floor Moins Building, Near Manorama Junction<br>
Panampilly Nagar Pin: 682036</p>
        <p><i class="fa fa-volume-control-phone" aria-hidden="true"></i> 9544773656, 9544778622, 9037735602</p>
