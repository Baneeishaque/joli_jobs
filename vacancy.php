  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12" style="margin-left: -2%;">
        <div class="col-md-4"><select data-filter="price" class="filter-price filter form-control">
          <option value="">SelectAll</option>
          <option value="">Mechanic</option>
            <option value="">Accountatnt</option>
            <option value="">Web designer</option>
        </select>&nbsp;</div>
        <div class="col-md-4">
            <button type="submit" class="btn btn-block btn-primary" style="width: 28%;background-color: #3e7b54;">Search</button>
            </div>
        </div>
      </div>
        <div class="fasil hidden-xs">
             <div class="row">
    <div class="col-md-4" style="color:#fff;">Tittle</div>
            <div class="col-md-6" style="color:#fff;">Description</div>
            <div class="col-md-2" style="color:#fff;">Apply</div>
  </div>
      </div>
      ...
      <div class="box">
          <div class="row">
  <div class="col-md-4">
     <h4><?php echo $fetch['tittle'] ?></h4>
    <span class="function"><?php echo $fetch['date'] ?></span>
  </div>
 <div class="col-md-6">
    <h4><?php echo $fetch['description'] ?></h4>
  </div>
  <div class="col-md-2">
    <a class="button" href="apply-job-vacancy.php?applyId=<?php echo $fetch['id']?> " target="blank" >Apply</a>
  </div>
  </div>
</div>
<?php 
