...
<section>
    <div class="container">
        <div class="container">
            ...
            <!-- Submit Application-->
            <form class="konnect-form" action="pushdata.php" method="post" id="regForm" name="regForm"
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" id="confirmpassword"
                                       placeholder="Conform password" onfocusout="return Validate()" required
                                       minlength="5"/>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="dob" id="name" placeholder="Date of birth"
                               required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="comment" placeholder="Payment" name="payment"
                               required>
                    </div>
                </div>
        ...
        <div class="checkbox">
            <label><input name="condition_accept" type="checkbox" id="apply_job_desclaimer_checkbox" required> Accept<a
                        href="Termsandconditions.html" target="blank">Terms and conditions</a> </label>
        </div>


        <div class="row">
            <div class="col-md-12"><br>
                <input type="submit" name="submit" id="registration_dummy_submit_button" class="konnect-submit"
                       disabled>
                <button onClick="window.location.reload();" class="konnect-submit" style="background-color: red;">
                    Cancel
                </button>
            </div>
        </div>
            ...
            <div class="col-sm-6 text-left">
                ...
                <div class="contact-social">
                    <p><a
                                ...
                                target="blank"> <i class="fa fa-facebook"></i> </a> <a href="#"> <i
